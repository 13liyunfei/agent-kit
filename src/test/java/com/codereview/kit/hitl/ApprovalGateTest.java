...
class ApprovalGateTest {
    ...
    @Test
    void submitDecideQueryStatusFlow() {
    ...
    @Test
    void awaitBlocksUntilHumanDecision() throws InterruptedException {
        InMemoryApprovalGate gate = new InMemoryApprovalGate();
    ...
    @Test
    void awaitTimesOutReturnsNullOrPending() throws InterruptedException {
        InMemoryApprovalGate gate = new InMemoryApprovalGate();
