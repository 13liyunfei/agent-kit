...
class PlanningTest {
    ...
    @Test
    void decomposesIntoDagOnValidJson() {
    ...
    @Test
    void fallsBackToSingleTaskOnInvalidJson() {
    ...
    @Test
    void dagRunsTopologicallyInDiamondOrder() {
    ...
    @Test
    void downstreamSkippedOnUpstreamFailure() {
        TaskPlan plan = new TaskPlanner(new FakeLlm(PLAN_JSON)).plan("g", null);
